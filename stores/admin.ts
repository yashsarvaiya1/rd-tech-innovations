...
interface AdminState {
  ...
  clearError: () => void;
  updateContentField: (sectionId: string, sectionKey: string, field: string, value: any) => Promise<void>;
  toggleSectionVisibility: (sectionId: string, sectionKey: string) => Promise<void>;
  addArrayItem: (sectionId: string, sectionKey: string, field: string, item: any) => Promise<void>;
  updateArrayItem: (sectionId: string, sectionKey: string, field: string, index: number, item: any) => Promise<void>;
  removeArrayItem: (sectionId: string, sectionKey: string, field: string, index: number) => Promise<void>;
  fetchSubmissionsByType: (type: "enquiry" | "career") => Promise<void>;
  updateSubmissionStatus: (submissionId: string, status: string) => Promise<void>;
    ...
    (set, get) => ({
      ...
      fetchContent: async (section) => {
        ...
        try {
          ...
          const errorMessage = error instanceof FirebaseError ? error.message : "Failed to fetch content";
      ...
      fetchSubmissions: async () => {
        ...
        try {
          ...
          const errorMessage = error instanceof FirebaseError ? error.message : "Failed to fetch submissions";
      ...
      fetchAdmins: async () => {
        ...
        try {
          ...
          const errorMessage = error instanceof FirebaseError ? error.message : "Failed to fetch admins";
      ...
      updateContentField: async (sectionId, sectionKey, field, value) => {
        ...
        try {
          ...
          console.log(`[AdminStore] Updating field ${field} in ${sectionKey} for section: ${sectionId}`);
          await ContentService.updateSectionField(sectionId, sectionKey, field, value);
          ...
          const errorMessage = error instanceof FirebaseError ? error.message : "Failed to update field";
      ...
      toggleSectionVisibility: async (sectionId, sectionKey) => {
        ...
        try {
          ...
          console.log(`[AdminStore] Toggling visibility for ${sectionKey} in section: ${sectionId}`);
          const newHiddenState = await ContentService.toggleSectionVisibility(sectionId, sectionKey);
          ...
          const errorMessage = error instanceof FirebaseError ? error.message : "Failed to toggle visibility";
      ...
      addArrayItem: async (sectionId, sectionKey, field, item) => {
        ...
        try {
          ...
          const errorMessage = error instanceof FirebaseError ? error.message : "Failed to add item";
      ...
      updateArrayItem: async (sectionId, sectionKey, field, index, item) => {
        ...
        try {
          ...
          console.log(`[AdminStore] Updating item at index ${index} in ${field}`);
          await ContentService.updateArrayItem(sectionId, sectionKey, field, index, item);
          ...
          const errorMessage = error instanceof FirebaseError ? error.message : "Failed to update array item";
      ...
      removeArrayItem: async (sectionId, sectionKey, field, index) => {
        ...
        try {
          ...
          console.log(`[AdminStore] Removing item at index ${index} from ${field}`);
          await ContentService.removeArrayItem(sectionId, sectionKey, field, index);
          ...
          const errorMessage = error instanceof FirebaseError ? error.message : "Failed to remove array item";
      ...
      fetchSubmissionsByType: async (type) => {
        ...
        try {
          ...
          const submissions = await SubmissionService.fetchSubmissionsByType(type);
          
          set({ submissions });
          console.log(`[AdminStore] Fetched ${submissions.length} ${type} submissions`);
          
        } catch (error) {
          const errorMessage = error instanceof FirebaseError ? error.message : `Failed to fetch ${type} submissions`;
          console.error(`[AdminStore] Error fetching ${type} submissions:`, error);
          setError(errorMessage);
        } finally {
          setLoading(false);
        }
      ...
      updateSubmissionStatus: async (submissionId, status) => {
        ...
        try {
          ...
          console.log(`[AdminStore] Updating submission ${submissionId} status to: ${status}`);
          ...
          const errorMessage = error instanceof FirebaseError ? error.message : "Failed to update submission status";
          console.error("[AdminStore] Error updating submission status:", error);
          setError(errorMessage);
        }
      },
      ...
      fetchSubmissionStats: async () => {
        ...
        try {
          ...
          console.log("[AdminStore] Submission stats fetched successfully:", stats);
          
        } catch (error) {
          const errorMessage = error instanceof FirebaseError ? error.message : "Failed to fetch submission stats";
      ...
      addAdminEmail: async (email) => {
        ...
        try {
          ...
          const errorMessage = error instanceof FirebaseError ? error.message : "Failed to add admin";
      ...
      removeAdmin: async (email) => {
        ...
        try {
          ...
          const errorMessage = error instanceof FirebaseError ? error.message : "Failed to remove admin";
