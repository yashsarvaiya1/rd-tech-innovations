"use client";
import { Edit, ExternalLink, Globe, Zap } from "lucide-react";
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-gray-600 mt-1">
          Routes are automatically detected from your app structure. Admin and
          Auth pages are excluded from public navigation.
        </p>
      </div>
          ...
          <Card key={route.path}>
            <CardContent className="p-4">
              ...
              <div className="mt-3 p-2 bg-blue-50 rounded text-xs text-blue-700">
                <strong>Visitor Experience:</strong> Sees "
                {routeNames[index] || route.displayName}" in navigation →
      ...
      <div className="text-xs text-gray-500 bg-gray-50 p-3 rounded flex items-start space-x-2">
        ...
        <div>
          <strong>Dynamic Detection:</strong> Routes are automatically detected
          from your Next.js app structure. Only public-facing pages are shown.
          Admin (/admin) and Authentication (/auth) routes are excluded
          automatically.
        </div>
      </div>
    </div>
