      ...
      <div className="w-full max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                ...
                >
                  ...
                  <div className="relative z-10 space-y-5">
                    ...
                    <div className="flex items-center space-x-4">
                      <div className={`w-12 h-12 bg-gradient-to-br ${gradient} rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                    ...
                    <div className={`w-8 h-0.5 bg-gradient-to-r ${gradient} rounded-full opacity-0 group-hover:opacity-100 group-hover:w-16 transition-all duration-500`} />
                  </div>

                  {/* ✅ Enhanced hover effects */}
                  <div className={`absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-accent/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-xl pointer-events-none`} />
                  
                  {/* ✅ Floating accent element */}
                  <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-10 transition-opacity duration-500">
                    <div className={`w-20 h-20 bg-gradient-to-br ${gradient} rounded-full blur-xl`} />
                  </div>
        ...
        {cards.length === 0 && (title || description) && (
          ...
          >
            ...
            <h3 className="text-xl font-heading font-bold text-foreground mb-4">Vision Cards Coming Soon</h3>
