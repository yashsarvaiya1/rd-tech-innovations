export interface NavbarContent {
  logoUrl?: string;
  hidden?: boolean;
  routesList?: { name: string; path: string }[]; // Updated to support label and path
...
export interface CareerContent {
  ...
  form?: {
    ...
    ctc: string;
    candidateAbout: string; // Renamed from 'about' to avoid conflict
    resumeUrl: string;
    positions: string[];
  };
}
